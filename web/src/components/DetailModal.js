    ...
    <div class="modal-header">
      <div>
        <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
          ...
          ${item.unit_number ? `<span style="background: rgba(2, 132, 199, 0.2); color: #38bdf8; border: 1px solid rgba(2, 132, 199, 0.4); font-size: 0.75rem; font-weight: 700; padding: 2px 8px; border-radius: 4px;">Unit ${item.unit_number}</span>` : ''}
