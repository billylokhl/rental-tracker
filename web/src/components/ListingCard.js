    ...
    <div class="card-top-row">
      <div class="card-title-group">
        <div style="display: flex; align-items: baseline; gap: 0.5rem; flex-wrap: wrap;">
          ...
          <a href="${listingUrl}" target="_blank" rel="noopener noreferrer" class="listing-external-link" title="Open original listing" onclick="event.stopPropagation();" style="display: inline-flex; align-items: center; gap: 0.2rem; font-size: 0.75rem; color: #38bdf8; text-decoration: underline; font-weight: 600;">
            <span>Listing ↗</span>
          </a>
        </div>
