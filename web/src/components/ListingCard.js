    ...
    <div class="card-top-row">
      <div class="card-title-group">
        <div style="display: flex; align-items: baseline; gap: 0.5rem; flex-wrap: wrap;">
          ...
          ${item.unit_number ? `<span style="background: rgba(2, 132, 199, 0.2); color: #38bdf8; border: 1px solid rgba(2, 132, 199, 0.4); font-size: 0.6875rem; font-weight: 700; padding: 2px 6px; border-radius: 4px;">${item.unit_number.startsWith('Unit') ? item.unit_number : `Unit ${item.unit_number}`}</span>` : ''}
